...
do -- Example UI
local Window = library:AddWindow("vaifuzz#3511 (JUST AIMBOT STUFF)", {
		main_color = Color3.fromRGB(41, 74, 122),
	...
	do -- Elements
		Tab:AddLabel("Made By vaifuzz#3511 (JUST AIMBOT STUFF)")
		
		Tab:AddButton("Aimbot (Q)", function()
		  local Settings = {
    AimLock = {
        Enabled = true,
        Aimlockkey = "q",
...
Tab:AddButton("Cam Lock (C)", function()
    getgenv().Prediction = 0.1248710929171	
getgenv().AimPart = "HumanoidRootPart"	
getgenv().Key = "c"	
getgenv().DisableKey = "x"	
    ...
    if k == SelectedKey then	
        if AimlockState == true then	
            ...
            if Locked then	
                ...
                Notify("vaifuzz#3511 Locked onto: "..tostring(Victim.Character.Humanoid.DisplayName))	
            else	
                if Victim ~= nil then	
                    Victim = nil	
